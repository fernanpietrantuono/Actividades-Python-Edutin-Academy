"""
Inicializo el descuento en 0 porque el programa puede tomarlo
como una variable sin definir
"""
descuento = 0
...
print(f'Hola {nombre}, estos son los valores de tu compra:'
      f'Compra sin descuento: U$S {subtotal}'
      f'Compra con descuento del {int(descuento * 100)}%: U$S {total}')
