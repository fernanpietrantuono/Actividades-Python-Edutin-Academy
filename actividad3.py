...
"""
El programa solamente pide el nombre de el/la estudiante y
...
while cont <= asignaturas:
    """ 
    Dentro del bucle se solicita el nombre de la materia
    ...
    """
    A cada nota que ingresa por teclado, se guardará en la suma para
    luego promediar las 5 materias totales y al contador se le suma un
    punto por vuelta hasta llegar al límite asignado inicialmente
    """
    suma += nota
    cont += 1

""" 
Se calcula el promedio de la suma de las notas obtenidas en el 5°
semestre por la X cantidad de notas y luego muestra el promedio al
estudiante
"""
